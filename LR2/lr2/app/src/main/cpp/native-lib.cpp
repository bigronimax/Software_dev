...
char *personalization = "lr2-sample-app";

#define LOG_INFO(...) __android_log_print(ANDROID_LOG_INFO, "lr2_ndk", __VA_ARGS__)

#define SLOG_INFO(...) android_logger->info( __VA_ARGS__ )
auto android_logger = spdlog::android_logger_mt("android", "lr2_ndk");

extern "C" JNIEXPORT jstring JNICALL
Java_ru_iu3_lr2_MainActivity_stringFromJNI(
        JNIEnv* env,
        jobject /* this */) {
    std::string hello = "Hello from C++";
    LOG_INFO("Hello from spdlog 2025");
...
Java_ru_iu3_lr2_MainActivity_initRng(JNIEnv *env, jclass clazz) {
...
Java_ru_iu3_lr2_MainActivity_randomBytes(JNIEnv *env, jclass, jint no) {
...
extern "C" JNIEXPORT jbyteArray JNICALL
Java_ru_iu3_lr2_MainActivity_encrypt(JNIEnv *env, jclass, jbyteArray key, jbyteArray data)
{
...
extern "C" JNIEXPORT jbyteArray JNICALL
Java_ru_iu3_lr2_MainActivity_decrypt(JNIEnv *env, jclass, jbyteArray key, jbyteArray data)
{
    jsize ksz = env->GetArrayLength(key);
    jsize dsz = env->GetArrayLength(data);
